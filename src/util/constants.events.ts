...
export enum FlushEvent {
  ...
  CREATE_MEMBER_PLANS = 'CREATE_MEMBER_PLANS',
  ...
  ON_FLUSH = 'ON_FLUSH',
  PROMOTE_MEMBERS = 'PROMOTE_MEMBERS',
  REMOVE_STRIPE_SUBSCRIPTION_ID = 'REMOVE_STRIPE_SUBSCRIPTION_ID',
  RESPOND_TO_APPLICANTS = 'RESPOND_TO_APPLICANTS',
  RESTORE_MEMBERS = 'RESTORE_MEMBERS',
  UPDATE_EVENT = 'UPDATE_EVENT',
  UPDATE_GOOGLE_CALENDAR_EVENT_ID = 'UPDATE_GOOGLE_CALENDAR_EVENT_ID',
  UPDATE_GOOGLE_ID = 'UPDATE_GOOGLE_ID',
  ...
  UPDATE_MEMBER_VALUES = 'UPDATE_MEMBER_VALUES',
  UPDATE_PICTURE_URL = 'UPDATE_PICTURE_URL',
  UPDATE_QUESTION = 'UPDATE_QUESTION',
  UPDATE_RECORDING_URL = 'UPDATE_RECORDING_URL',
  ...
  UPDATE_STRIPE_PAYMENT_METHOD_ID = 'UPDATE_STRIPE_PAYMENT_METHOD_ID',

...
export enum QueryEvent {
  GET_ACTIVE_GROWTH = 'GET_ACTIVE_GROWTH',
  GET_ACTIVE_GROWTH_SERIES = 'GET_ACTIVE_GROWTH_SERIES',
  GET_ACTIVE_MEMBER_ANALYTICS = 'GET_ACTIVE_MEMBER_ANALYTICS',
  GET_APPLICANTS = 'GET_APPLICANTS',
  GET_APPLICATION = 'GET_APPLICATION',
  GET_DIRECTORY = 'GET_DIRECTORY',
  GET_DUES_ANALYTICS = 'GET_DUES_ANALYTICS',
  GET_INTEGRATIONS = 'GET_INTEGRATIONS',
  GET_MEMBERS = 'GET_MEMBERS',
  GET_PAYMENTS = 'GET_PAYMENTS',
  GET_PAYMENT_HISTORY = 'GET_PAYMENT_HISTORY',
  GET_TOTAL_DUES_COLLECTED = 'GET_TOTAL_DUES_COLLECTED',
  GET_TOTAL_GROWTH = 'GET_TOTAL_GROWTH',
  GET_TOTAL_GROWTH_SERIES = 'GET_TOTAL_GROWTH_SERIES',
